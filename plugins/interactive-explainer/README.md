...
PR inputs also run the `review` skill from the [GitHub plugin](../github), with findings in a dedicated **PR review** section on the page and nothing posted to GitHub. Install both plugins for PR explainers. Pages follow the system theme and prefer locally installed Helvetica Neue, with local font fallbacks and no font downloads.
